...
/**
 * Utility class for visualizing data using JFreeChart.
 */
public class DataVisualizer {

    /**
     * Visualizes data using the specified chart type.
     *
     * Parameters:
     * cleanedData - The cleaned data to be visualized
     * feature - The feature of the data to visualize
     * frameTitle - The title of the visualization frame
     * chartType - The type of chart to use ("bar", "line", or "pie")
     */
